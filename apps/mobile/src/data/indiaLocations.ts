/**
 * Static India state/district reference data for location dropdowns.
 * Hand-authored from general public knowledge of state/district boundaries —
 * some states have had recent district reorganizations (e.g. Andhra Pradesh,
 * Assam, Rajasthan), so treat this as a good-enough starting point and
 * correct/expand entries as needed rather than a guaranteed-authoritative source.
 * Mandal/tehsil-level data is intentionally not included here (see NewRequest's
 * free-text Mandal/Area field) — that dataset will be added in a follow-up.
 */
...
export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  Maharashtra: [
    ...
    "Nashik", "Dharashiv", "Palghar", "Parbhani", "Pune", "Raigad", "Ratnagiri", "Sangli",
...
export const INDIA_STATES: string[] = Object.keys(DISTRICTS_BY_STATE).sort();

export const ALL_DISTRICTS: string[] = Object.values(DISTRICTS_BY_STATE).flat().sort();
